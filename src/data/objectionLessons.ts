...
export const objectionLessons: Record<string, Lesson> = {
  "O1": {
    ...
    sections: [
      ...
      {
        type: "quote",
        text: "If someone can afford a {currency}5 coffee every day, they can afford a {currency}300 product that lasts a whole year. That's less than {currency}1 a day for younger-looking skin.",
        textEs: "Si alguien puede pagarse un café de {currency}5 todos los días, puede pagarse un producto de {currency}300 que le dura un año entero. Es menos de {currency}1 al día por verse más joven.",
      },
      {
        type: "subheader",
      ...
      {
        type: "script",
        text: "YOU: \"I totally get it — we're all on a budget, right? But check this out: this one syringe lasts you a YEAR. Sixty goes in there, one a week, and you don't buy it again until next summer. That's less than {currency}1 a day. You spend more on coffee! And this doesn't just wake you up — it takes 10 years off your face. Want me to show you how?\"",
        textEs: "TÚ: \"Lo entiendo perfectamente — todos andamos con el presupuesto justo, ¿verdad? Pero fíjate: esta jeringa te dura un AÑO. Sesenta aplicaciones, una por semana, y no la vuelves a comprar hasta el verano que viene. Es menos de {currency}1 al día. ¡Te gastas más en café! Y esto no solo te despierta — te quita 10 años de encima. ¿Quieres que te enseñe cómo?\"",
      },
      {
        type: "subheader",
      ...
      {
        type: "script",
        text: "YOU: \"Listen, I get it — {currency}300 sounds like a lot. But let me ask you something: how much is a facial at a spa? {currency}80, right? And it's gone in an hour. This syringe is sixty applications — one a week, that's your whole year covered. Less than {currency}5 a go. You're literally saving hundreds compared to a salon. And in any store back home, this is {currency}500.\"",
        textEs: "TÚ: \"Mira, lo entiendo — {currency}300 suena a mucho. Pero déjame preguntarte algo: ¿cuánto cuesta un facial en un spa? {currency}80, ¿verdad? Y se acabó en una hora. Esta jeringa son sesenta aplicaciones — una por semana, tienes el año entero cubierto. Menos de {currency}5 cada vez. Estás ahorrando cientos comparado con un salón. Y en cualquier tienda de tu país, esto cuesta {currency}500.\"",
      },
      {
        type: "subheader",
      ...
      {
        type: "script",
        text: "YOU: \"I hear you. Can I ask you something real quick — how much do you spend on skincare in a year? Creams, serums, masks, spa visits?\" [Let them answer] \"Okay, so let's say {currency}800, {currency}1,200 a year on stuff that gives you... what? A little moisture? This right here is concentrated hyaluronic acid — the same thing celebrities pay thousands for. One syringe. One year. Sixty applications, one a week, and you do not buy it again until next summer. So that's {currency}300 against the {currency}1,200 you're already handing over — except this one you can watch working in 60 seconds. Look at my client's face right here — 60 seconds ago she had that line, now look. That line is GONE. You're not buying a cream, you're buying a time machine. And spread across the year it's under {currency}1 a day — less than the coffee you bought on the way here. Now tell me — doesn't your face deserve the same investment as your morning coffee?\"",
        textEs: "TÚ: \"Te entiendo. ¿Puedo preguntarte algo rapidísimo — cuánto te gastas en cuidado de la piel al año? Cremas, sueros, mascarillas, spa?\" [Déjalos responder] \"Vale, digamos {currency}800, {currency}1,200 al año en cosas que te dan... ¿qué? ¿Un poquito de hidratación? Esto de aquí es ácido hialurónico concentrado — lo mismo que los famosos pagan a miles. Una jeringa. Un año. Sesenta aplicaciones, una por semana, y no la vuelves a comprar hasta el verano que viene. O sea {currency}300 contra los {currency}1,200 que ya te estás dejando — solo que este lo ves funcionar en 60 segundos. Mira la cara de mi clienta aquí — hace 60 segundos tenía esa línea, ahora mira. Esa línea ha DESAPARECIDO. No estás comprando una crema, estás comprando una máquina del tiempo. Y repartido en el año sale por menos de {currency}1 al día — menos que el café que te has tomado de camino. Ahora dime — ¿tu cara no merece la misma inversión que tu café de la mañana?\"",
      },
      {
        type: "subheader",
        text: "What NOT to Do",
      ...
      {
        type: "tip",
        text: "The under-{currency}1-a-day reframe is your golden weapon, and it only works because the syringe genuinely lasts a year — sixty applications, one a week. Practice saying it naturally in both languages. Also — always carry your phone calculator. Show them the math in real time. \"{currency}300 divided by 365 days... look, that's not even {currency}1 a day.\" Seeing the number makes it real.",
        textEs: "Lo de \"menos de {currency}1 al día\" es tu arma dorada, y funciona porque la jeringa dura de verdad un año — sesenta aplicaciones, una por semana. Practica decirlo natural en los dos idiomas. Además — lleva siempre la calculadora del móvil. Enséñales la cuenta en directo. \"{currency}300 entre 365 días... mira, ni {currency}1 al día.\" Ver el número lo hace real.",
      },
    ],
    quiz: [
      {
        question: 'She says {currency}300 is a lot more than she planned to spend today. What has she actually told you?',
        questionEs: 'Te dice que {currency}300 es mucho más de lo que pensaba gastarse hoy. ¿Qué te está diciendo en realidad?',
        options: [
          'That she cannot afford it — show her something cheaper',
          'That she is finished — thank her and let her go',
          'That she wants convincing — she has not said no',
          'That she wants the real number, so go straight down to your floor price',
        ],
        optionsEs: [
          'Que no le llega — enséñale algo más barato',
          'Que ha terminado — dale las gracias y déjala ir',
          'Que quiere que la convenzas — no te ha dicho que no',
          'Que quiere el número de verdad, así que baja ya a tu precio mínimo',
        ],
        correctIndex: 2,
        explanation:
          'Nobody haggles over something they do not want. "I am on a budget" is an invitation to make the number small, not a no.',
        explanationEs:
          'Nadie regatea por algo que no quiere. "Ando corto de dinero" es una invitación a hacer el número pequeño, no un no.',
      },
      {
        question: 'One syringe, sixty applications, one a week. Which line shrinks the price?',
        questionEs: 'Una jeringa, sesenta aplicaciones, una por semana. ¿Qué frase hace pequeño el precio?',
        options: [
          '"One syringe, a whole year — that is under {currency}1 a day"',
          '"It is really not that expensive when you think about it"',
          '"Everybody says the price is high, you are not the only one"',
          '"It is the cheapest thing on this whole table, so it is basically nothing at all"',
        ],
        optionsEs: [
          '"Una jeringa, un año entero — menos de {currency}1 al día"',
          '"No es tan caro si lo piensas bien, de verdad"',
          '"Todo el mundo dice que es caro, no eres la única"',
          '"Es lo más barato de toda esta mesa, así que en realidad no es nada de nada"',
        ],
        correctIndex: 0,
        explanation:
          'The syringe lasts a year, so the number gets divided by 365 and not by anything smaller. A day at a time is a number she can hear.',
        explanationEs:
          'La jeringa dura un año, así que el número se divide entre 365 y no entre nada más pequeño. Un día cada vez es un número que sí se oye.',
      },
      {
        question: 'Your last customer bought one syringe. How do you use her in front of this one?',
        questionEs: 'Tu última clienta se llevó una jeringa. ¿Cómo la usas delante de esta?',
        options: [
          '"The lady before you took three" — it shows the product moves',
          '"My last one only took one, so let me do something nice for you"',
          'Keep her out of it — other customers always sound like pressure',
          'Tell her the last three people all bought and she is the only one still thinking',
        ],
        optionsEs: [
          '"La señora de antes se llevó tres" — así ve que el producto sale',
          '"La última solo se llevó uno, así que déjame hacerte algo bonito"',
          'Déjala fuera — hablar de otras clientas siempre suena a presión',
          'Dile que los tres últimos compraron y que ella es la única que lo piensa',
        ],
        correctIndex: 1,
        explanation:
          'Same customer, two endings. One makes her feel behind, the other makes her feel picked. Always give, never nag.',
        explanationEs:
          'La misma clienta, dos finales. Uno la hace sentirse la última, el otro la hace sentirse elegida. Regala siempre, no des la lata.',
      },
    ],
  },
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          ...
          'Take {currency}40 off before the page has even finished loading',
        ],
        optionsEs: [
          ...
          'Quitarle {currency}40 antes de que se le cargue la página',
        ],
        correctIndex: 1,
        explanation:
