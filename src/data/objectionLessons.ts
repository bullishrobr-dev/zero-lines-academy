...
export const objectionLessons: Record<string, Lesson> = {
  ...
  "O2": {
    ...
    sections: [
      ...
      {
        type: "script",
        text: "YOU: \"I totally understand! But here's the thing — this is tax-free {locationName}. The moment you cross that border, the exact same syringe is {currency}500 in a shop. This offer is right here, right now. And honestly? The results you just saw don't need thinking — they need action. Grab it while you're here!\"",
        textEs: "TÚ: \"¡Totalmente entiendo! Pero fíjate — esto es {locationName} libre de impuestos. En cuanto cruces esa frontera, esta misma jeringa cuesta {currency}500 en una tienda. Esta oferta es aquí, ahora. Y honestamente? Los resultados que acabas de ver no necesitan pensarse — necesitan acción. ¡Agárralo mientras estás aquí!\"",
      },
      {
        type: "subheader",
  ...
  "O3": {
    ...
    sections: [
      ...
      },
      {
        ...
        textEs: "TÚ: \"¡Me encanta que te importe lo que piensen! Aquí está el truco — esto no es solo para ti. Agarra el kit de uñas para tu hija, el scrub para tu esposa, y la jeringa para ti. ¡Ahora es un regalo familiar de {locationName}! Nadie puede enfadarse por un regalo.\"",
      },
      {
        type: "subheader",
  ...
  "O6": {
    ...
    sections: [
      ...
      },
      {
        ...
        itemsEs: [
          "Compra Basada en Valores: Estos clientes votan con su billetera. No buscan precio; buscan valores. Gana en ética, y el precio se vuelve secundario.",
  ...
  "O7": {
    ...
    sections: [
      ...
      {
        type: "script",
        text: "YOU: \"Let's do the math together. Amazon price — what, maybe {currency}280 with shipping? And you wait a week. Then you open it and hope it's real. Here? You're in {locationName} — this is already tax-free. {currency}300, done. You walk out with it TODAY. You know it works because you felt it on YOUR skin. And if anything goes wrong? You come find ME — I'm right here. On Amazon, you're talking to a chatbot. So the real question is: is saving {currency}20 worth risking your face on a counterfeit from who-knows-where?\"",
        textEs: "TÚ: \"Hagamos la matemática juntos. Precio en Amazon — ¿qué, tal vez {currency}280 con envío? Y esperas una semana. Luego lo abres y esperas que sea real. ¿Aquí? Estás en {locationName} — esto ya es libre de impuestos. {currency}300, listo. Sales con él HOY. Sabes que funciona porque lo sentiste en TU piel. ¿Y si algo sale mal? Vienes a buscarme a MÍ — estoy aquí mismo. En Amazon, hablas con un chatbot. Entonces la pregunta real es: ¿ahorrar {currency}20 vale arriesgar tu cara en una falsificación de quién-sabe-dónde?\"",
      },
      {
        type: "subheader",
  ...
  "O9": {
    ...
    sections: [
      ...
      {
        type: "tip",
        text: "The free sample to the friend is a MASTER move. It costs you almost nothing, makes the friend feel included rather than pressured, and sets up a return visit. Many times the friend comes back the NEXT DAY because she tried the sample and loved it. Also, when working with groups, always identify the \"alpha\" — the person others look to for approval. Win the alpha, win the group.",
        textEs: "La muestra gratis para la amiga es un movimiento MAESTRO. Te cuesta casi nada, hace que la amiga se sienta incluida en vez de presionada, y prepara una visita de regreso. Muchas veces la amiga regresa al DÍA SIGUIENTE porque probó la muestra y le encantó. Además, cuando trabajas con grupos, siempre identifica a la \"alfa\" — la persona a quien las demás buscan para aprobación. Gana a la alfa, gana al grupo.",
      },
    ],
    quiz: [],
  },
