...
export const objectionLessons: Record<string, Lesson> = {
  ...
  "O2": {
    ...
    sections: [
      ...
      },
      {
        ...
        textEs: "TÚ: \"¡Totalmente entiendo! Pero fíjate — ahora mismo estás en {locationName}. En cuanto cruces esa frontera, esta misma jeringa cuesta {currency}500 en una tienda. Esta oferta es aquí, ahora. Y honestamente? Los resultados que acabas de ver no necesitan pensarse — necesitan acción. ¡Agárralo mientras estás aquí!\"",
      },
      {
        type: "subheader",
  ...
  "O7": {
    ...
    sections: [
      ...
      {
        type: "script",
        text: "YOU: \"Let's do the math together. Amazon price — what, maybe {currency}280 with shipping? And you wait a week. Then you open it and hope it's real. Here? You're in {locationName}. {currency}300, done. You walk out with it TODAY. You know it works because you felt it on YOUR skin. And if anything goes wrong? You come find ME — I'm right here. On Amazon, you're talking to a chatbot. So the real question is: is saving {currency}20 worth risking your face on a counterfeit from who-knows-where?\"",
