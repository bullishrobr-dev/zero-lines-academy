    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          `"Shall we split it — half on this card, half on the other one?" Two cards, or a card and whatever cash she has on her.`,
          `Cash, and this is your best answer, not your last one: "Cash suits me even better, my love. There's a machine two minutes that way — I'll walk you over and carry the bag." You go WITH her. Never send her off on her own, however close it is and however busy the table is.`,
          `If the money genuinely is not there, be lovely about it, hands empty, and get straight back on the floor.`,
        ],
        itemsEs: [
          ...
          `"¿Lo partimos — la mitad en esta tarjeta y la mitad en la otra?" Dos tarjetas, o una tarjeta y el efectivo que lleve encima.`,
          `Efectivo, y esta es tu mejor respuesta, no la última: "En efectivo aún mejor, cariño. Hay un cajero a dos minutos — te acompaño yo y te llevo la bolsa." Vas CON ella. Nunca la mandes sola, por cerca que esté y por muy liada que esté la mesa.`,
          `Si el dinero de verdad no está, sé un encanto, con las manos vacías, y vuelve directo al suelo.`,
        ],
      },
      {
        type: 'keypoint',
