export interface ObjectionLesson {
  id: string;
  ...
  icon: string;
  sections: {
    type: 'text' | 'quote' | 'script' | 'tip' | 'bullets' | 'compare';
    text: string;
    textEs: string;
  }[];
}

export const objectionLessons: ObjectionLesson[] = [
  // ============================================================
  // O1: "I'm on a Budget"
  // ============================================================
  {
    ...
    sections: [
      ...
      {
        type: "quote",
        text: "\"If someone can afford a €5 coffee every day, they can afford a €140 product that lasts 3 months. That's €1.50 per day for younger-looking skin.\"",
        textEs: "\"Si alguien puede pagar un café de €5 todos los días, puede pagar un producto de €140 que le dura 3 meses. Son €1.50 al día para verse más joven.\""
      },
      {
        type: "text",
      ...
      {
        type: "bullets",
        text: "• **Loss Aversion**: People feel losses 2x more intensely than equivalent gains. Spending €140 feels like a loss, not an investment.\\n• **Mental Accounting**: Tourists have a \"vacation budget\" compartment. You need to move the purchase from \"vacation splurge\" to \"smart tax-free investment.\"\\n• **Price Anchoring**: They compare €140 to €0, not to €200+ retail or €1,200+ salon treatments.",
        textEs: "• **Aversión a la Pérdida**: La gente siente las pérdidas 2 veces más intensamente que las ganancias equivalentes. Gastar €140 se siente como una pérdida, no una inversión.\\n• **Contabilidad Mental**: Los turistas tienen un compartimento de \"presupuesto de vacaciones\". Necesitas mover la compra de \"gasto de vacaciones\" a \"inversión inteligente libre de impuestos.\"\\n• **Anclaje de Precio**: Comparan €140 con €0, no con €200+ en tiendas o €1,200+ en tratamientos de salón."
      },
      {
        type: "text",
      ...
      {
        type: "script",
        text: "YOU: \"I totally get it — we're all on a budget, right? But check this out: this one syringe lasts you 3 months. That's €1.50 a day. You spend more on coffee! And this doesn't just wake you up — it takes 10 years off your face. Want me to show you how?\"",
        textEs: "TÚ: \"Totally lo entiendo — todos andamos con presupuesto, ¿verdad? Pero fíjate: esta jeringa te dura 3 meses. Son €1.50 al día. ¡Gastas más en café! Y esto no solo te despierta — te quita 10 años de encima. ¿Quieres que te enseñe cómo?\""
      },
      {
        type: "text",
      ...
      {
        type: "script",
        text: "YOU: \"Listen, I get it — €140 sounds like a lot. But let me ask you something: how much is a facial at a spa? €80, right? And it's gone in an hour. This product gives you 60 to 80 applications — that's less than €2 per use. You're literally saving hundreds compared to a salon. Plus, we're tax-free here. In any store back home, this is €200+.\"",
        textEs: "TÚ: \"Mira, lo entiendo — €140 suena a mucho. Pero déjame preguntarte algo: ¿cuánto cuesta un facial en un spa? €80, ¿verdad? Y se acabó en una hora. Este producto te da de 60 a 80 aplicaciones — son menos de €2 por uso. Literal estás ahorrando cientos comparado con un salón. Además, aquí somos libres de impuestos. En cualquier tienda en tu país, esto cuesta €200+.\""
      },
      {
        type: "text",
      ...
      {
        type: "script",
        text: "YOU: \"I hear you. Can I ask you something real quick — how much do you spend on skincare in a year? Creams, serums, masks, spa visits?\" [Let them answer] \"Okay, so let's say €300, €500 a year on stuff that gives you... what? A little moisture? This right here is concentrated hyaluronic acid — the same thing celebrities pay thousands for. One syringe, 3 months. That's 4 syringes a year. €560 total for results you can actually see in 60 seconds. Look at my client's face right here — 60 seconds ago she had that line, now look. That line is GONE. You're not buying a cream, you're buying a time machine. And at €1.55 a day, that's cheaper than your Netflix subscription. Now tell me — doesn't your face deserve the same investment as your entertainment?\"",
        textEs: "TÚ: \"Te entiendo. ¿Puedo preguntarte algo rapidísimo — cuánto gastas en cuidado de piel al año? Cremas, sueros, mascarillas, visitas al spa?\" [Déjalos responder] \"Okay, digamos €300, €500 al año en cosas que te dan... ¿qué? ¿Un poquito de humedad? Esto de aquí es ácido hialurónico concentrado — lo mismo que los famosos pagan miles. Una jeringa, 3 meses. Son 4 jeringas al año. €560 total por resultados que puedes ver en 60 segundos. Mira la cara de mi clienta aquí — hace 60 segundos tenía esa línea, ahora mira. Esa línea DESAPARECIÓ. No estás comprando una crema, estás comprando una máquina del tiempo. Y a €1.55 al día, es más barato que tu suscripción de Netflix. Ahora dime — ¿tu cara no merece la misma inversión que tu entretenimiento?\""
      },
      {
        type: "text",
        text: "## What NOT to Do",
      ...
      {
        type: "bullets",
        text: "❌ **Dismiss their concern**: \"Oh, it's not that expensive\" — this makes them feel stupid and shuts down the conversation.\\n❌ **Immediately drop the price**: Offering a discount before they even object kills your credibility.\\n❌ **Compare them to other buyers**: \"The lady before you bought three!\" — creates pressure, not desire.\\n❌ **Walk away**: If they're still standing there, they're still interested. Work with them.",
        textEs: "❌ **Menospreciar su preocupación**: \"Ah, no es tan caro\" — esto los hace sentirse tontos y cierra la conversación.\\n❌ **Bajar el precio de inmediato**: Ofrecer descuento antes de que objeten mata tu credibilidad.\\n❌ **Compararlos con otros compradores**: \"¡La señora de antes compró tres!\" — crea presión, no deseo.\\n❌ **Irte**: Si todavía están ahí parados, todavía les interesa. Trabaja con ellos."
      },
      {
        type: "tip",
        text: "💡 **PRO TIP**: The €1.50/day reframe is your golden weapon. Practice saying it naturally in both languages. Also — always carry your phone calculator. Show them the math in real time. \"€140 divided by 90 days... look, €1.55 a day.\" Seeing the number makes it real.",
        textEs: "💡 **TIP PRO**: La reconversión de €1.50 al día es tu arma dorada. Practica decirla natural en ambos idiomas. Además — siempre carga la calculadora de tu celular. Muéstrales la matemática en tiempo real. \"€140 dividido entre 90 días... mira, €1.55 al día.\" Ver el número lo hace real."
      }
    ]
  },

  // ============================================================
  // O2: "Let Me Think About It"
  // ============================================================
  {
    id: 'O2',
    categoryId: 'objections',
    ...
    sections: [
      ...
      {
        type: "bullets",
        text: "• **Decision Paralysis**: Too many options or too much information freezes the brain. Street demos create instant desire, but the purchasing decision still requires a mental \"leap.\"\\n• **Fear of Regret**: They imagine buying it, going home, and thinking \"I shouldn't have spent that.\" You need to flip this — make them fear missing out MORE than buying.\\n• **Politeness Buffer**: Most people won't say \"no\" to your face. They use \"thinking about it\" as an escape hatch. Your job is to keep the door open.",
        textEs: "• **Parálisis de Decisión**: Demasiadas opciones o demasiada información congela el cerebro. Las demos en la calle crean deseo instantáneo, pero la decisión de compra todavía requiere un \"salto\" mental.\\n• **Miedo al Arrepentimiento**: Se imaginan comprándolo, llegando a casa, y pensando \"no debí gastar eso.\" Necesitas voltear esto — haz que teman perderse la oportunidad MÁS que comprar.\\n• **Cortesía de Escape**: La mayoría no te dirá \"no\" a la cara. Usan \"pensarlo\" como escapatoria. Tu trabajo es mantener la puerta abierta."
      },
      {
        type: "text",
      ...
      {
        type: "script",
        text: "YOU: \"I totally understand! But here's the thing — this is tax-free Gibraltar. Once you get on that cruise ship [or cross that border], the price doubles. This offer is right here, right now. And honestly? The results you just saw don't need thinking — they need action. Grab it while you're here!\"",
        textEs: "TÚ: \"¡Totalmente entiendo! Pero fíjate — esto es Gibraltar libre de impuestos. Una vez que subas a ese crucero [o cruces esa frontera], el precio se duplica. Esta oferta es aquí, ahora. Y honestamente? Los resultados que acabas de ver no necesitan pensarse — necesitan acción. ¡Agárralo mientras estás aquí!\""
      },
      {
        type: "text",
        text: "## Script 2: The Risk Reversal (Medium)",
        textEs: "## Guion 2: La Reversión de Riesgo (Medio)"
      },
      {
        type: "script",
        text: "YOU: \"I get it, it's a big decision. But let me ask you — what specifically are you unsure about? Is it the price? The product? Or you just need to sleep on it?\" [Let them answer] \"Listen, you saw the results with your own eyes. I'm so confident in this product that I'll make you a deal: buy it today, try it for a week. If you don't love it, message me. I'll help you with the return. But I promise you — a week from now you'll be messaging me to say THANK YOU. So... are you going to think about looking younger, or are you going to DO it?\"",
        textEs: "TÚ: \"Lo entiendo, es una decisión grande. Pero déjame preguntarte — ¿qué te tiene insegura específicamente? ¿El precio? ¿El producto? ¿O solo necesitas dormir sobre eso?\" [Déjalos responder] \"Mira, viste los resultados con tus propios ojos. Estoy tan segura de este producto que te hago un trato: cómpralo hoy, pruébalo por una semana. Si no te encanta, mándame mensaje. Te ayudo con la devolución. Pero te prometo — dentro de una semana me vas a mandar mensaje para decirme GRACIAS. Entonces... ¿vas a pensar en verte más joven, o vas a HACERLO?\""
      },
      {
        type: "text",
      ...
      },
      {
        ...
        textEs: "TÚ: \"Te escucho — pensarlo tiene sentido. Pero déjame ser honesta contigo un segundo.\" [Acércate, baja la voz] \"Tuve una señora ayer, igual que tú. Piel hermosa, una línea aquí que no le gustaba. Dijo 'déjame pensarlo.' Regresó DOS HORAS después — la línea todavía estaba ida, no podía dejar de tocar su cara — y ya nos habíamos agotado. Me rogó que le guardara uno. No pude. Se fue deshecha. Ahora mírate — viste tus propias arrugas desaparecer en 60 segundos. SABES que funciona. Esta no es una decisión de pensar, es una decisión de sentir. Y tu piel está sintiéndose INCREÍBLE ahora mismo. Solo nos quedan pocas unidades hoy. No te lo digo para presionarte — te lo digo porque no quiero que TÚ seas la que regrese en dos horas y descubra que ya no hay. Entonces, ¿qué dices — te envuelvo uno?\""
      },
      {
        type: "text",
        text: "## What NOT to Do",
      ...
      {
        type: "bullets",
        text: "❌ **Say \"OK, take your time\"** — You've just killed the sale. They'll walk away and the desire fades within minutes.\\n❌ **Offer a discount to force the close** — This devalues the product and trains customers to hesitate for a better deal.\\n❌ **Make them feel pressured** — Aggressive tactics trigger fight-or-flight. They'll say no just to escape.\\n❌ **Let them leave without YOUR contact info** — If they insist on leaving, at least make sure they can find you tomorrow.",
        textEs: "❌ **Decir \"OK, tómate tu tiempo\"** — Acabas de matar la venta. Se irán caminando y el deseo se desvanece en minutos.\\n❌ **Ofrecer descuento para forzar el cierre** — Esto devalúa el producto y entrena a los clientes a dudar para obtener mejor trato.\\n❌ **Hacerlos sentir presionados** — Tácticas agresivas activan la respuesta de lucha o huida. Dirán que no solo para escapar.\\n❌ **Dejarlos irse sin TU información de contacto** — Si insisten en irse, al menos asegúrate de que puedan encontrarte mañana."
      },
      {
        type: "tip",
        text: "💡 **PRO TIP**: Create a genuine reason for urgency. Check your stock before each shift and know what's running low. \"Only 3 left\" is powerful ONLY when it's true. Customers can smell fake scarcity from a mile away. Also — take a photo with them after the demo (with permission). When they look at that photo later and see the difference, they'll come back. Or better — they'll buy on the spot.",
        textEs: "💡 **TIP PRO**: Crea una razón genuina de urgencia. Revisa tu inventario antes de cada turno y sabe qué se está acabando. \"Solo quedan 3\" es poderoso SOLO cuando es verdad. Los clientes pueden oler escasez falsa a kilómetros de distancia. Además — tómate una foto con ellos después de la demo (con permiso). Cuando vean esa foto más tarde y vean la diferencia, regresarán. O mejor — comprarán en el momento."
      }
    ]
  },

  // ============================================================
  // O3: "My Husband/Wife Will Kill Me"
  // ============================================================
  {
    id: 'O3',
    categoryId: 'objections',
    ...
    sections: [
      ...
      {
        type: "script",
        text: "YOU: \"I love that you care what they think! Here's the move — this isn't just for you. Grab the nail kit for your daughter, the scrub for your wife, and the syringe for yourself. Now it's a family gift from Gibraltar! No one can be mad about a gift.\"",
        textEs: "TÚ: \"¡Me encanta que te importe lo que piensen! Aquí está el truco — esto no es solo para ti. Agarra el kit de uñas para tu hija, el scrub para tu esposa, y la jeringa para ti. ¡Ahora es un regalo familiar de Gibraltar! Nadie puede enojarse por un regalo.\""
      },
      {
        type: "text",
      ...
      },
      {
        ...
        textEs: "TÚ: \"Okay, hablando en serio. ¿Cuántas veces te has puesto a ti al último? Los niños primero, el esposo primero, el trabajo primero... ¿cuándo fue la última vez que hiciste algo SOLO para ti?\" [Déjalos pensar] \"Mira lo que acaba de pasar. En 60 segundos, viste años desaparecer de tu cara. Sentiste eso. Vi tu cara iluminarse. Tu pareja te ama, ¿verdad? Quiere que te sientas hermosa. Quiere que estés segura de ti misma. Entonces esto es lo que haces: entras esta noche, lo miras a los ojos, y dices 'me di un gusto hoy. Porque me lo merezco. Y MIRA.'\" [Señala su piel] \"No estarán enojados. Estarán asombrados. Y honestamente? Si alguien se enoja porque inviertes en ti misma... esa es una conversación que vale la pena tener. Entonces — ¿lo envolvemos como un 'regalo para mí' o un 'regalo para nosotros'?\""
      },
      {
        type: "text",
        text: "## What NOT to Do",
      ...
      {
        type: "bullets",
        text: "❌ **Badmouth their partner**: \"He sounds controlling!\" — This creates division, not desire.\\n❌ **Minimize the relationship**: \"Don't ask, just do it!\" — You're asking them to betray trust for a product. Bad strategy.\\n❌ **Ignore the objection**: Pretending they didn't mention a partner makes you tone-deaf.\\n❌ **Suggest they hide it**: Dishonesty stories backfire. Give them an honest narrative that wins.",
        textEs: "❌ **Hablar mal de su pareja**: \"¡Suena controlador!\" — Esto crea división, no deseo.\\n❌ **Minimizar la relación**: \"¡No preguntes, solo hazlo!\" — Les estás pidiendo que traicionen confianza por un producto. Mala estrategia.\\n❌ **Ignorar la objeción**: Pretender que no mencionaron pareja te hace parecer sordo.\\n❌ **Sugerir que lo escondan**: Las historias de deshonestidad se voltean en contra. Dale una narrativa honesta que gane."
      },
      {
        type: "tip",
        text: "💡 **PRO TIP**: Always suggest the \"gift for two\" angle. Even if they came alone, saying \"get one for your partner too\" changes the frame from selfish purchase to thoughtful gesture. Plus — you just doubled your sale. The phrase \"He'll thank you later\" or \"Ella te lo va a agradecer\" is magic.",
        textEs: "💡 **TIP PRO**: Siempre sugiere el ángulo de \"regalo para dos.\" Aunque hayan venido solos, decir \"lleva uno para tu pareja también\" cambia el marco de compra egoísta a gesto considerado. Además — acabas de duplicar tu venta. La frase \"Él te lo va a agradecer después\" o \"Ella te lo va a agradecer\" es mágica."
      }
    ]
  },

  // ============================================================
  // O4: "I Was Scammed Before"
  // ============================================================
  {
    id: 'O4',
    categoryId: 'objections',
  ...
  // ============================================================
  {
    ...
    sections: [
      ...
      {
        type: "script",
        text: "YOU: \"I'm SO glad you asked. A lot of people don't care — but the ones who do? They're our people.\" [Pull up certification] \"So here's the deal: our brand is built on three words — Clean, Pure, Conscious. CLEAN means no parabens, no sulfates, no phthalates. PURE means Dead Sea minerals, plant extracts, essential oils — stuff that comes from the earth, not a lab. CONSCIOUS means cruelty-free, sustainably sourced, recyclable packaging.\" [Point to specific products] \"This syringe? Hyaluronic acid — your own body makes it. This scrub? Dead Sea salt and algae — literally from the sea. This peeling? Glycolic acid from sugar cane. Everything is from nature. And because our ingredients are this clean and this pure, they don't NEED animal testing — they work because nature works.\" [Pause, make eye contact] \"You know what the best part is? Our best customers are the ethical ones. Because once they try it and see that 'clean' doesn't mean 'weak' — that natural can actually be MORE powerful than chemical — they never go back. You care about what goes on your skin AND what doesn't hurt animals? You're exactly who we made this for.\"",
        textEs: "TÚ: \"Me ALEGRA MUCHO que hayas preguntado. Mucha gente no le importa — pero a los que sí? Esos son nuestra gente.\" [Muestra certificación] \"Así está la cosa: nuestra marca se construye sobre tres palabras — Limpio, Puro, Consciente. LIMPIO significa sin parabenos, sin sulfatos, sin ftalatos. PURO significa minerales del Mar Muerto, extractos de plantas, aceites esenciales — cosas que vienen de la tierra, no de un laboratorio. CONSCIENTE significa libre de crueldad, de fuentes sostenibles, empaque reciclable.\" [Señala productos específicos] \"¿Esta jeringa? Ácido hialurónico — tu propio cuerpo lo produce. ¿Este scrub? Sal y algas del Mar Muerto — literalmente del mar. ¿Este peeling? Ácido glicólico de caña de azúcar. Todo es de la naturaleza. Y como nuestros ingredientes son así de limpios y puros, no NECESITAN pruebas en animales — funcionan porque la naturaleza funciona.\" [Pausa, haz contacto visual] \"¿Sabes cuál es la mejor parte? Nuestros mejores clientes son los éticos. Porque una vez que lo prueban y ven que 'limpio' no significa 'débil' — que natural puede ser MÁS poderoso que químico — nunca regresan atrás. ¿Te importa qué pones en tu piel Y qué no lastima animales? Eres exactamente para quien hicimos esto.\""
      },
      {
        type: "text",
        text: "## What NOT to Do",
  ...
  // ============================================================
  {
    ...
    sections: [
      ...
      {
        type: "script",
        text: "YOU: \"Maybe — but here's the thing about Amazon skincare. Counterfeit cosmetics are a €3 billion industry. That 'deal' you find? Probably fake, expired, or diluted. This?\" [Hold up sealed product] \"Sealed, fresh, straight from the manufacturer. And you just watched it work on your own face. Can Amazon do that?\"",
        textEs: "TÚ: \"Tal vez — pero esto es lo del skincare en Amazon. Los cosméticos falsificados son una industria de €3 mil millones. ¿Esa 'ganga' que encuentras? Probablemente falsa, vencida, o diluida. ¿Esto?\" [Levanta producto sellado] \"Sellado, fresco, directo del fabricante. Y acabas de verlo funcionar en tu propia cara. ¿Amazon puede hacer eso?\""
      },
      {
        type: "text",
      ...
      {
        type: "script",
        text: "YOU: \"Let's do the math together. Amazon price — what, maybe €130 with shipping? And you wait a week. Then you open it and hope it's real. Here? You're in Gibraltar — this is already tax-free. €140, done. You walk out with it TODAY. You know it works because you felt it on YOUR skin. And if anything goes wrong? You come find ME — I'm right here. On Amazon, you're talking to a chatbot. So the real question is: is saving €10 worth risking your face on a counterfeit from who-knows-where?\"",
        textEs: "TÚ: \"Hagamos la matemática juntos. Precio en Amazon — ¿qué, tal vez €130 con envío? Y esperas una semana. Luego lo abres y esperas que sea real. ¿Aquí? Estás en Gibraltar — esto ya es libre de impuestos. €140, listo. Sales con él HOY. Sabes que funciona porque lo sentiste en TU piel. ¿Y si algo sale mal? Vienes a buscarme a MÍ — estoy aquí mismo. En Amazon, hablas con un chatbot. Entonces la pregunta real es: ¿ahorrar €10 vale arriesgar tu cara en una falsificación de quién-sabe-dónde?\""
      },
      {
        type: "text",
      ...
      {
        type: "script",
        text: "YOU: \"Amazon, right? Everyone goes there first. But let me ask you — when you buy skincare on Amazon, what are you actually buying? A photo, a description, and a prayer. You don't know if it's been sitting in a warehouse for 18 months. You don't know if it's been exposed to heat. You don't know if it's even REAL — because fake cosmetics are everywhere now.\" [Pull out your phone, show news about counterfeit cosmetics if you have it] \"Now look at what just happened here. I put this on your face. You FELT the texture. You SAW the wrinkle disappear in 60 seconds. You're holding the sealed box in your hands. This is a full EXPERIENCE, not a transaction. And here's what people forget: Amazon charges VAT. Gibraltar doesn't. So when you see that €120 on Amazon, add 20% VAT, add shipping, add the risk... you're at €150+ anyway. And you waited a week for something that might be fake. Here? €140. Real. Fresh. Instant. In your bag.\" [Pause] \"Listen, I'm not here to rip you off. I'm here because this product changed MY skin, and I love sharing that. But I also know that the version on Amazon isn't this version. This is the real deal, right here, right now. So — do you want to risk your face on a website, or do you want to walk out looking 10 years younger TODAY?\"",
        textEs: "TÚ: \"Amazon, ¿verdad? Todos van ahí primero. Pero déjame preguntarte — cuando compras skincare en Amazon, ¿qué estás comprando realmente? Una foto, una descripción, y una oración. No sabes si ha estado en un almacén por 18 meses. No sabes si ha estado expuesto al calor. No sabes si siquiera es REAL — porque los cosméticos falsos están por todos lados ahora.\" [Saca tu celular, muestra noticias sobre cosméticos falsificados si tienes] \"Ahora mira lo que acaba de pasar aquí. Te puse esto en la cara. SENTISTE la textura. VISTE la arruga desaparecer en 60 segundos. Estás sosteniendo la caja sellada en tus manos. Esto es una EXPERIENCIA completa, no una transacción. Y esto es lo que la gente olvida: Amazon cobra VAT. Gibraltar no. Entonces cuando ves eso de €120 en Amazon, agrégale 20% VAT, envío, más el riesgo... estás en €150+ de todos modos. Y esperaste una semana por algo que podría ser falso. ¿Aquí? €140. Real. Fresco. Instantáneo. En tu bolsa.\" [Pausa] \"Escucha, no estoy aquí para estafarte. Estoy aquí porque este producto cambió MI piel, y me encanta compartir eso. Pero también sé que la versión en Amazon no es esta versión. Este es el producto real, aquí, ahora. Entonces — ¿quieres arriesgar tu cara en un sitio web, o quieres salir viéndote 10 años más joven HOY?\""
      },
      {
        type: "text",
        text: "## What NOT to Do",
      ...
      {
        type: "bullets",
        text: "❌ **Trash Amazon completely**: Some people love Amazon. Don't make them feel stupid for using it.\\n❌ **Refuse to acknowledge the price difference**: Admit it exists, then reframe around value.\\n❌ **Say \"you can't find this on Amazon\" unless it's TRUE**: Lying about availability destroys trust if they check.\\n❌ **Discount to match Amazon**: You're not competing on price — you're competing on experience.",
        textEs: "❌ **Hablar mal de Amazon por completo**: Algunos aman Amazon. No los hagas sentirse tontos por usarlo.\\n❌ **Negar la diferencia de precio**: Admítela, luego reconvertir alrededor del valor.\\n❌ **Decir \"no encuentras esto en Amazon\" a menos que sea CIERTO**: Mentir sobre disponibilidad destruye confianza si checan.\\n❌ **Hacer descuento para igualar Amazon**: No compites en precio — compites en experiencia."
      },
      {
        type: "tip",
        text: "💡 **PRO TIP**: Keep a screenshot on your phone of a news article about counterfeit cosmetics on Amazon. When you pull it up and say \"Look, this was last month — €3 billion in fake skincare seized,\" it becomes REAL. Also, the phrase \"You're not paying for the product, you're paying for the guarantee\" is your best closer. People will pay €20 more for peace of mind.",
        textEs: "💡 **TIP PRO**: Guarda una captura de pantalla en tu celular de un artículo de noticias sobre cosméticos falsificados en Amazon. Cuando la sacas y dices \"Mira, esto fue el mes pasado — €3 mil millones en skincare falso decomisado,\" se vuelve REAL. Además, la frase \"No estás pagando por el producto, estás pagando por la garantía\" es tu mejor cierre. La gente pagará €20 más por tranquilidad."
      }
    ]
  },

  // ============================================================
  // O8: "The Demo Didn't Work on Me"
  // ============================================================
  {
    id: 'O8',
    categoryId: 'objections',
    ...
    sections: [
      ...
      },
      {
        ...
        textEs: "TÚ: \"Okay, yo también lo veo — déjame averiguar por qué. ¿Te pusiste bloqueador o crema hidratante esta mañana?\" [Responden] \"Eso es — hay una barrera en tu piel. Déjame prepararla diferente. Un segundo.\" [Limpia el área, reaplica] \"Mira esta vez.\""
      },
      {
        type: "text",
      ...
      {
        type: "bullets",
        text: "❌ **Blame their skin**: \"Your skin is just bad\" — insulting the customer is career suicide.\\n❌ **Pretend it worked**: \"You can't see it but I can!\" — they KNOW it didn't work. Dishonesty kills trust.\\n❌ **Give up on the sale**: A failed syringe demo is a perfect opportunity to sell the scrub or glycolic peel instead.\\n❌ **Get flustered or apologetic**: Stay calm and clinical. \"Let's diagnose this together\" shows expertise.",
        textEs: "❌ **Culpar su piel**: \"Tu piel es mala\" — insultar al cliente es suicidio profesional.\\n❌ **Pretender que funcionó**: \"¡Tú no puedes verlo pero yo sí!\" — ellos SABEN que no funcionó. La deshonestidad mata la confianza.\\n❌ **Rendirte con la venta**: Una demo fallida de jeringa es una oportunidad perfecta para vender el scrub o el peeling glicólico en su lugar.\\n❌ **Ponerte nervioso o a la defensiva**: Mantén la calma y sé clínico. \"Diagnosticemos esto juntos\" muestra experiencia."
      },
      {
        type: "tip",
        text: "💡 **PRO TIP**: ALWAYS carry makeup remover wipes and toner. 70% of \"failed demos\" are because of sunscreen, moisturizer, or makeup blocking absorption. Prep the skin before the demo and your success rate will triple. Also, the failed-demo pivot to scrub is one of your best sales moves — you turn disappointment into a €35 sale AND set up a €140 future sale. Master this.",
        textEs: "💡 **TIP PRO**: SIEMPRE carga toallitas removedoras de maquillaje y tónico. El 70% de las 'demos fallidas' son por bloqueador, crema hidratante, o maquillaje bloqueando la absorción. Prepara la piel antes de la demo y tu tasa de éxito se triplicará. Además, el giro de demo fallida a scrub es uno de tus mejores movimientos de venta — conviertes decepción en una venta de €35 Y preparas una venta futura de €140. Domina esto."
      }
    ]
  },

  // ============================================================
  // O9: "My Friend Said No"
  // ============================================================
  {
    id: 'O9',
    categoryId: 'objections',
    ...
    sections: [
      ...
      {
        type: "text",
        text: "## Script 2: The Gift for the Friend (Medium)",
        textEs: "## Guion 2: El Regalo para la Amiga (Medio)"
      },
      {
        type: "script",
        text: "YOU: \"I get it — you came here together, you're deciding together. But tell you what — let me give your friend a FREE sample of the Dead Sea Scrub. No charge, no pressure. She tries it tonight, and if she loves it, she'll be the one dragging YOU back here tomorrow.\" [Hand the sample] \"And YOU — you saw the results on your own face. Don't let someone else's 'no' steal your 'yes.' This is between you and your mirror.\"",
        textEs: "TÚ: \"Lo entiendo — vinieron juntas, están decidiendo juntas. Pero fíjate — déjame darle a tu amiga una muestra GRATIS del Scrub del Mar Muerto. Sin cobro, sin presión. Ella lo prueba esta noche, y si le encanta, ella será la que te ARRASTRE de vuelta aquí mañana.\" [Entrega la muestra] \"Y TÚ — tú viste los resultados en tu propia cara. No dejes que el 'no' de alguien más te robe tu 'sí.' Esto es entre tú y tu espejo.\""
      },
      {
        type: "text",
      ...
      {
        type: "script",
        text: "YOU: \"I totally get it — you guys are a team, and I respect that. But let me ask you both something: when you go home tonight, are you going to be looking at HER face in the mirror, or YOUR face?\" [Look at the interested person] \"Look, she loves you — that's why she's protective. But this isn't a timeshare, it's not a scam, it's skincare. You felt it work. You saw that line disappear. That's not peer pressure, that's physics.\" [Turn to the friend] \"And honestly? I love that you have her back. That's real friendship. But real friendship also means supporting what makes your friend feel beautiful. She wants this. She's just waiting for your blessing. So what do you say — can your girl treat herself?\" [Address the interested person] \"Here's what we'll do: you take it. If you don't absolutely love it in a week, you come back and I'll personally help you with the return. But I know you won't — because you already saw it work.\"",
        textEs: "TÚ: \"Totalmente lo entiendo — ustedes son un equipo, y respeto eso. Pero déjenme preguntarles algo a las dos: cuando lleguen a casa esta noche, ¿van a estar viendo la cara de ELLA en el espejo, o SU cara?\" [Mira a la persona interesada] \"Mira, ella te quiere — por eso es protectora. Pero esto no es un timeshare, no es una estafa, es cuidado de la piel. Sentiste que funcionó. Viste esa línea desaparecer. Eso no es presión de grupo, eso es física.\" [Vuelvete hacia la amiga] \"¿Y honestamente? Me encanta que la cuidas. Esa es amistad real. Pero la amistad real también significa apoyar lo que hace sentir bella a tu amiga. Ella quiere esto. Solo está esperando tu bendición. Entonces, ¿qué dices — ¿tu amiga puede darse un gusto?\" [Dirígete a la persona interesada] \"Esto es lo que haremos: llévatelo. Si no te encanta absolutamente en una semana, regresas y yo personalmente te ayudo con la devolución. Pero sé que no lo harás — porque ya viste que funcionó.\""
      },
      {
        type: "text",
        text: "## What NOT to Do",
      ...
      {
        type: "bullets",
        text: "❌ **Turn them against each other**: \"She's just jealous!\" — Creates conflict, not sales.\\n❌ **Pressure the friend**: Trying to hard-sell the resistant friend makes the whole group leave.\\n❌ **Ignore the friend completely**: The friend has power. Win her over, or at least neutralize her.\\n❌ **Discount to \"save\" the sale**: Bargain hunting spreads in groups. One discount = four future \"no's\" expecting discounts too.",
        textEs: "❌ **Enfrentarlas**: \"¡Solo está celosa!\" — Crea conflicto, no ventas.\\n❌ **Presionar a la amiga**: Tratar de venderle a la amiga resistente hace que todo el grupo se vaya.\\n❌ **Ignorar a la amiga por completo**: La amiga tiene poder. Gánatela, o al menos neutralízala.\\n❌ **Hacer descuento para \"salvar\" la venta**: La búsqueda de gangas se propaga en grupos. Un descuento = cuatro \"no's\" futuros esperando descuentos también."
      },
      {
        type: "tip",
        text: "💡 **PRO TIP**: The free sample to the friend is a MASTER move. It costs you almost nothing, makes the friend feel included rather than pressured, and sets up a return visit. Many times the friend comes back the NEXT DAY because she tried the sample and loved it. Also, when working with groups, always identify the \"alpha\" — the person others look to for approval. Win the alpha, win the group.",
        textEs: "💡 **TIP PRO**: La muestra gratis para la amiga es un movimiento MAESTRO. Te cuesta casi nada, hace que la amiga se sienta incluida en vez de presionada, y prepara una visita de regreso. Muchas veces la amiga regresa al DÍA SIGUIENTE porque probó la muestra y le encantó. Además, cuando trabajas con grupos, siempre identifica a la \"alfa\" — la persona a quien las demás buscan para aprobación. Gana a la alfa, gana al grupo."
      }
    ]
  },

  // ============================================================
  // O10: "I Don't Have Cash / Card Not Working"
  // ============================================================
  {
    id: 'O10',
    categoryId: 'objections',
    ...
    sections: [
      ...
      {
        type: "bullets",
        text: "• **Embarrassment**: People feel ashamed when their card declines. Handle it with total grace — it happens to everyone.\\n• **Decision Fatigue**: They've already decided to buy; the payment issue is just a speed bump. Don't let it become a wall.\\n• **Loss Aversion**: If they walk away to \"get cash,\" 80% never come back. Find a way to close NOW.",
        textEs: "• **Vergüenza**: La gente se siente avergonzada cuando su tarjeta se declina. Mánjalo con total elegancia — le pasa a todos.\\n• **Fatiga de Decisión**: Ya decidieron comprar; el problema de pago es solo un bache. No dejes que se convierta en muro.\\n• **Aversión a la Pérdida**: Si se van a \"sacar efectivo,\" el 80% nunca regresa. Encuentra una forma de cerrar AHORA."
      },
      {
        type: "text",
      ...
      },
      {
        ...
        textEs: "TÚ: \"Los problemas de tarjeta en el extranjero son lo PEOR, lo sé. Me pasó en Barcelona el mes pasado. Esto es lo que podemos hacer: dividirlo entre dos tarjetas, o puedo guardar el producto por 30 minutos mientras sacas efectivo de ese cajero ahí.\" [Señala] \"¿O — tienes Apple Pay o Google Pay en tu celular? A veces eso funciona cuando la tarjeta física no. ¿Intentamos?\""
      },
      {
        type: "text",
      ...
      {
        type: "script",
        text: "YOU: \"Okay, let's solve this together — because I don't want a little card hiccup to stop you from getting something you love.\" [Be calm, problem-solving tone] \"Let's go through our options one by one. Option one: do you have another card? Debit, credit, even a prepaid travel card?\" [If yes, try it] \"Option two: Apple Pay, Google Pay, Samsung Pay — anything on your phone?\" [If yes, set it up] \"Option three: split payment. Put €70 on this card, €70 in cash. Or any combination.\" [Work with them] \"Option four: I literally hold the product, put your name on it, and you have 20 minutes to hit that ATM right across the street. No one else gets it.\" [Show the tax-free receipt] \"And here's the best part — you get this tax-free receipt. So if for ANY reason you change your mind, you can get a full VAT refund at the border. Zero risk. So... which option works? Because I'm not letting you walk away from results like these over a card glitch.\"",
        textEs: "TÚ: \"Okay, resolvamos esto juntos — porque no quiero que un pequeño problema de tarjeta te impida llevarte algo que amas.\" [Sé calmado, tono de resolución de problemas] \"Revisemos nuestras opciones una por una. Opción uno: ¿tienes otra tarjeta? Débito, crédito, incluso una tarjeta de viaje prepagada?\" [Si sí, inténtala] \"Opción dos: Apple Pay, Google Pay, Samsung Pay — ¿algo en tu celular?\" [Si sí, configúralo] \"Opción tres: pago dividido. Pon €70 en esta tarjeta, €70 en efectivo. O cualquier combinación.\" [Trabaja con ellos] \"Opción cuatro: literalmente guardo el producto, pongo tu nombre en él, y tienes 20 minutos para ir a ese cajero justo cruzando la calle. Nadie más se lo lleva.\" [Muestra el recibo libre de impuestos] \"Y aquí está la mejor parte — recibes este recibo libre de impuestos. Entonces si por CUALQUIER razón cambias de opinión, puedes obtener el reembolso completo de VAT en la frontera. Cero riesgo. Entonces... ¿cuál opción funciona? Porque no voy a dejar que te vayas de resultados como estos por un fallo de tarjeta.\""
      },
      {
        type: "text",
        text: "## What NOT to Do",
