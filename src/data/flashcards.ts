...
export const flashcards: Flashcard[] = [
  ...
  },
  {
    ...
    questionEs: '¿Cuáles son los 3 Detonadores de Urgencia para que compren de inmediato?',
    answerEs: '1) Stock limitado, 2) Bono solo por hoy, 3) Prueba social — "El último se vendió justo ahora en la esquina."',
  },
  {
    id: 'sp-2-2',
    lessonId: 'psych-7',
    ...
    questionEs: '¿Cómo creas el miedo a quedarse fuera (FOMO) sin ser agresivo?',
    answerEs: 'Presenta la escasez como un hecho, no como una amenaza: "Este lote se agotó en 2 días la semana pasada."',
  },
  {
    id: 'sp-3-1',
    lessonId: 'connect-7',
    ...
    questionEs: '¿Cuáles son las 3 Señales de Compra de que el cliente está listo?',
    answerEs: '1) Toca el producto, 2) Pregunta el precio, 3) "¿Cuánto dura?" — Estas son luces verdes para cerrar la venta.',
  },
  {
    id: 'sp-3-2',
    lessonId: 'connect-7',
  ...
  },
  {
    ...
    lessonId: 'prod-5',
    categoryId: 'sales-psychology',
    question: 'She has paid for the syringe. What is the very next thing out of your mouth?',
    answer: 'Not another product. You build the specialist up — only here a short time, amazing at what he does — then: "just because you got this, I\'m going to spoil you with a small gift." Give before you ask. She has just spent money; the next thing she hears should not be you wanting more.',
    questionEs: 'Ha pagado la jeringa. ¿Qué es lo siguiente que sale de tu boca?',
    answerEs: 'Otro producto no. Le montas al especialista — está poco tiempo, es un crack en lo suyo — y luego: "solo porque te has llevado esto, te voy a mimar con un regalito." Das antes de pedir. Acaba de gastarse el dinero; lo siguiente que oiga no puede ser que quieras más.',
  },
  {
    id: 'sp-5-1',
    lessonId: 'prod-7',
    ...
    answer: '1) Fear of regret, 2) Fear of judgment, 3) Fear of waste, 4) Fear of change. Kill each one with the demo on their own hand and social proof.',
    questionEs: '¿Cuáles son los 4 Patrones de Miedo que frenan a los clientes?',
    answerEs: '1) Miedo a arrepentirse, 2) Miedo al qué dirán, 3) Miedo a tirar el dinero, 4) Miedo al cambio. Mata cada uno con la demo en su propia mano y con prueba social.',
  },
  {
    id: 'sp-5-2',
    lessonId: 'prod-7',
    ...
    answer: 'Not with a promise the shop has to honour later — we do not do returns. Take the fear off her, then hand the decision back: "You said you like it, you said you would use it. And if you really would not use it, keep your money — no hard feelings." Nobody regrets a decision they made themselves.',
    questionEs: '¿Cómo disuelves la objeción del "miedo a arrepentirse"?',
    answerEs: 'No con una promesa que la tienda tenga que cumplir después — nosotros no hacemos devoluciones. Quítale el miedo y devuélvele la decisión: "Me has dicho que te gusta, me has dicho que lo usarías. Y si de verdad no lo vas a usar, guárdate el dinero — sin rencores." Nadie se arrepiente de una decisión que ha tomado ella.',
  },
  {
    id: 'sp-6-1',
    lessonId: 'psych-7',
  ...
  },
  {
    ...
    answer: '"Think about what, my love? You told me you like it. You told me you would use it. So it is the price — say it out loud and let me see what I can do." Never park her at the counter and never send her for a wander: the second she is out of the door the price is gone and so is she.',
    questionEs: '¿Cuál es la mejor respuesta a "Necesito pensarlo"?',
    answerEs: '"¿Pensar el qué, cariño? Me has dicho que te gusta. Me has dicho que lo usarías. Entonces es el precio — dilo en voz alta y veo qué puedo hacer." Nunca la dejes esperando en caja ni la mandes a dar una vuelta: en cuanto sale por la puerta, el precio se va y ella también.',
  },
  {
    id: 'sp-7-1',
    lessonId: 'psych-7',
    ...
    questionEs: '¿Qué es la "Prueba Social" y cómo la usas eficazmente?',
    answerEs: 'Demuestra que otros como ellos ya compraron. Sé específico: "Una señora de tu edad compró 2 justo esta mañana."',
  },
  {
    id: 'sp-7-2',
    lessonId: 'psych-7',
  ...
  },
  {
    ...
    questionEs: '¿Qué es la técnica del "Gancho de Curiosidad" para abrir conversaciones?',
    answerEs: 'Di algo intrigante pero incompleto: "Tengo que preguntarte — ¿alguien te ha dicho que te pareces a..." y pausa. La curiosidad los atrae.',
  },
  {
    id: 'rc-2-2',
    lessonId: 'connect-1',
  ...
  },
  {
    ...
    questionEs: '¿Cuáles son las 3 Técnicas de Humor para romper la tensión?',
    answerEs: '1) Humor autocrítico (identificable), 2) Observacional ("¿Soy yo o..."), 3) Bromas juguetonas — nunca malintencionadas, siempre cariñosas.',
  },
  {
    id: 'rc-3-2',
    lessonId: 'stop-3',
  ...
  },
  {
    ...
    lessonId: 'connect-4',
    categoryId: 'reading-connecting',
    question: 'How many of a group do you actually demo?',
    answer: 'Three or fewer — do all of them. Four or more — take ONE volunteer ("who is the bravest?") and only open it up to the rest if you SEE real excitement. Doing everybody and selling nobody is the worst feeling in this job.',
    questionEs: '¿A cuántas de un grupo les haces la demo?',
    answerEs: 'Tres o menos — a todas. Cuatro o más — coges a UNA voluntaria ("¿quién es la más valiente?") y solo abres al resto si VES entusiasmo de verdad. Hacérselo a todas y no venderle a ninguna es la peor sensación de este trabajo.',
  },
  {
    id: 'rc-5-2',
    lessonId: 'connect-4',
  ...
  },
  {
    ...
    questionEs: '¿Qué es la "Técnica del Loro" para profundizar conversaciones?',
    answerEs: 'Repite las últimas 2-3 palabras que dijeron como pregunta. Ella: "He estado muy estresada en el trabajo." Tú: "¿Estresada en el trabajo?" — Se abrirán más.',
  },
  {
    id: 'rc-8-1',
    lessonId: 'connect-5',
  ...
  },
  {
    ...
    questionEs: '¿Qué es la técnica de la "Restricción de Tiempo Falsa"?',
    answerEs: '"Solo me quedo un minuto pero..." — reduce la presión de que se sientan comprometidos a una conversación larga. Se relajan y se abren.',
  },

  // ═══════════════════════════════════════════════════════════════════════════
  // ART OF STOPPING (16 cards)
  // ═══════════════════════════════════════════════════════════════════════════
  {
    id: 'aos-1-1',
    lessonId: 'stop-1',
    ...
    answer: 'The second they look at you, you move — inside 3 seconds. It runs off THEIR look, not off you spotting them. Any longer and the look goes cold and you have talked yourself out of it.',
    questionEs: '¿Qué es la "Regla de los 3 Segundos" al acercarte?',
    answerEs: 'En cuanto te miran, te mueves — en menos de 3 segundos. Va con SU mirada, no con que tú los veas a ellos. Si esperas más, la mirada se enfría y ya te has comido la cabeza.',
  },
  {
    id: 'aos-1-2',
    lessonId: 'psych-3',
  ...
  },
  {
    ...
    lessonId: 'stop-1',
    categoryId: 'art-of-stopping',
    question: 'What do you do before you take a single step towards someone?',
    answer: 'Get their eyes on you first. Four or five metres out, while they are still walking: "Hi guys, how you doing?" — and WAIT. Do not step, do not raise the sample. Only once they look do you lift it and go. Leave it until they are on top of you and they are past you before they have turned their head.',
    questionEs: '¿Qué haces antes de dar un solo paso hacia alguien?',
    answerEs: 'Consigue primero su mirada. A cuatro o cinco metros, cuando todavía vienen andando: "Hola chicos, ¿qué tal?" — y ESPERA. No des un paso, no levantes la muestra. Solo cuando te miren la levantas y vas. Si esperas a tenerlos encima, te han pasado de largo antes de girar la cabeza.',
  },
  {
    id: 'aos-3-2',
    lessonId: 'stop-1',
    categoryId: 'art-of-stopping',
    question: 'They wave the sample away. Now what?',
    answer: 'Nothing happens. The sample is a coin toss — you never asked them for anything, so you have not been rejected. You are still stood in front of them, so you carry straight on into the next line exactly the same. A hand that did not move is not an answer.',
    questionEs: 'Apartan la muestra con la mano. ¿Y ahora qué?',
    answerEs: 'No pasa nada. La muestra es cara o cruz — no les has pedido nada, así que no te han rechazado. Sigues plantado delante de ellos, así que pasas a la frase siguiente igual. Una mano que no se ha movido no es una respuesta.',
  },
  {
    id: 'aos-4-1',
    lessonId: 'psych-2',
    ...
    questionEs: '¿Qué es la "Transferencia de Energía" al detener?',
    answerEs: 'Tu energía determina la de ellos. Trae energía alta, positiva y cálida — la van a igualar. Baja energía = baja respuesta.',
  },
  {
    id: 'aos-4-2',
    lessonId: 'psych-1',
  ...
  },
  {
    ...
    questionEs: '¿Cuál es la fórmula de "Tonalidad Vocal" para el acercamiento?',
    answerEs: 'Volumen: Suficientemente alto para cortar el ruido. Ritmo: Un poco más lento de lo normal (autoridad calmada). Tono: Más bajo al final de las frases (certeza).',
  },
  {
    id: 'aos-8-2',
    lessonId: 'stop-7',
  ...
  },
  {
    ...
    questionEs: '¿Cuál es el punto clave de venta del efecto instantáneo de la Jeringa?',
    answerEs: 'Efecto lifting visible en 60 segundos. El contraste entre el ojo tratado y el no tratado se vende solo — no necesitas palabras.',
  },
  {
    id: 'pm-2-1',
    lessonId: 'prod-6',
    ...
    questionEs: '¿Cómo haces la demo del producto Peeling para máximo impacto?',
    answerEs: 'Aplica en el dorso de su mano, déjalo actuar 10 segundos, luego frota suavemente. La piel muerta saliendo es prueba visceral de exfoliación.',
  },
  {
    id: 'pm-2-2',
    lessonId: 'prod-1',
  ...
  },
  {
    ...
    lessonId: 'prod-5',
    categoryId: 'product-mastery',
    question: 'What is "the upsell" in this shop — and whose job is it?',
    answer: 'It is a HANDOVER, not you pitching a second product. Sell the syringe and you pass her to the upseller, who sells the red and infrared LED devices — the alternative to a facelift, gets the body making its own collagen and elastin, lifts the face. Selling the syringe is the win. What comes after it is somebody else\'s job.',
    questionEs: '¿Qué es "la venta adicional" en esta tienda, y de quién es el trabajo?',
    answerEs: 'Es un TRASPASO, no tú soltando un segundo producto. Vendes la jeringa y se la pasas al upseller, que vende los aparatos de LED rojo e infrarrojo — la alternativa al lifting, hace que el cuerpo produzca su propio colágeno y elastina, levanta la cara. Vender la jeringa es la victoria. Lo que viene después es de otro.',
  },
  {
    id: 'pm-5-2',
    lessonId: 'prod-7',
  ...
  },
  {
    ...
    answer: 'Name the good stuff and put it straight back on their hand — your hands are the proof, not a borrowed white coat. "Nothing to worry about, my love. Dead Sea minerals, vitamin E, all natural — no chemicals, no parabens, nothing in there to upset anybody\'s skin. Feel that."',
    questionEs: '¿Cómo manejas "¿Esto es natural/orgánico?" para cualquier producto?',
    answerEs: 'Nombra lo bueno y vuelve a ponérselo en la mano — la prueba son tus manos, no una bata blanca prestada. "No tienes nada de qué preocuparte, cariño. Minerales del Mar Muerto, vitamina E, todo natural — sin químicos, sin parabenos, nada que le pueda irritar la piel a nadie. Toca."',
  },
  {
    id: 'pm-7-1',
    lessonId: 'prod-4',
...
export function getFlashcardById(cardId: string): Flashcard | undefined {
  return flashcards.find((f) => f.id === cardId);
}
