...
export function getPriceStepsData(
  ...
  return [
    ...
    },
    {
      ...
      descriptionEs: 'Ventaja de paraíso fiscal — nuestro precio estándar',
      script: `"But here in ${locationName} — we're a tax haven — it's only ${currency}150!"`,
      scriptEs: `"¡Pero aquí en ${locationName} — somos un paraíso fiscal — es solo ${currency}150!"`,
      isHighlight: false,
    },
    {
      price: `${currency}100`,
    ...
    },
    {
      ...
      script: `"You know what, I totally understand. Let's make it easy — I can take away the Scrub, we charge ${currency}25 for it anyway, so let's just use it as a store credit. This way I can make it ${currency}70 for you."`,
      scriptEs: `"Sabes qué, te entiendo completamente. Hagámoslo fácil — puedo quitar el Exfoliante, de todos modos cobramos ${currency}25 por él, así que usemoslo como crédito de tienda. Así puedo dejártelo en ${currency}70."`,
      isHighlight: false,
    },
    {
      price: `${currency}50`,
      ...
      descriptionEs: 'Cupón del 20% — el empujón emocional final',
    ...
    },
    {
      ...
      descriptionEs: 'Piso absoluto — último recurso solo',
      script: `"Look, I really want you to try this. I'm doing something I shouldn't — ${currency}50, that's it. Just promise me you'll actually use it, okay? Not once a year — once a week."`,
      scriptEs: `"Mira, realmente quiero que pruebes esto. Estoy haciendo algo que no debería — ${currency}50, eso es todo. Solo prométeme que realmente lo usarás, ¿ok? No una vez al año — una vez por semana."`,
      isMinimum: true,
      isHighlight: false,
    },
  ];
