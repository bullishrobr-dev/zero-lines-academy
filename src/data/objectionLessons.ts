  ...
  "O9": {
    ...
    sections: [
      ...
      },
      {
        ...
        textEs: "La muestra gratis para la amiga es un movimiento MAESTRO. Te cuesta casi nada, hace que la amiga se sienta incluida en vez de presionada, y prepara una visita de vuelta. Muchas veces la amiga vuelve al DÍA SIGUIENTE porque probó la muestra y le encantó. Además, cuando trabajas con grupos, siempre identifica a la \"alfa\" — la persona a quien las demás buscan para aprobación. Gana a la alfa, gana al grupo.",
      },
    ],
    quiz: [],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        itemsEs: [
          ...
          "Decir \"vuelve después\" sin un plan: El 80% de los clientes \"ahora vuelvo\" nunca vuelven. Dale una solución concreta.",
