...
export const translations = {
  en: {
    ...
    achFirstSaleDesc: 'Sell something. You are not a trainee any more',
    achTenSales: 'Ten Sold',
    achTenSalesDesc: 'Ten sales. That is not luck twice',
    achBigDay: 'Big Day',
    achBigDayDesc: 'Five syringes in one shift',
    achWorkedTheFloor: 'Worked the Floor',
    achWorkedTheFloorDesc: 'Bring a hundred people inside',
    achCloser: 'Closer',
    achCloserDesc: 'Sell ten syringes',
  ...
  es: {
    ...
    achFirstSale: 'Primera Venta',
    achFirstSaleDesc: 'Vende algo. Ya no eres un aprendiz',
    achTenSales: 'Diez Vendidas',
    achTenSalesDesc: 'Diez ventas. Eso ya no es suerte',
    achBigDay: 'D\u00eda Grande',
    achBigDayDesc: 'Cinco jeringas en un turno',
    achWorkedTheFloor: 'Pisando Calle',
    achWorkedTheFloorDesc: 'Mete a cien personas dentro',
    achCloser: 'El Cerrador',
    achCloserDesc: 'Vende diez jeringas',
