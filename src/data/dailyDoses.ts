    ...
    content: [
      {
        ...
        textEs: 'Dónde te coloques importa tanto como lo que dices. Demasiado cerca = amenaza. Demasiado lejos = ignorado. La zona mágica es de 1.5 a 2 metros. Inclina tu cuerpo ligeramente de lado — es menos confrontacional.',
      ...
      },
      {
        ...
        textEs: 'Iguala su ritmo. Si van rápido, mete más energía. Si van paseando, baja el ritmo de tu acercamiento. Primero igualas, luego llevas tú.',
      },
    ],
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        textEs: '"Te acompaño — mi compañera [Nombre] te va a cuidar de maravilla. Es nuestra experta en piel y hoy tiene un regalo especial esperándote."',
      },
      {
        type: 'tip',
        ...
        textEs: 'Presenta siempre a tu compañera por su nombre. Di siempre lo que sabe. Siempre promete algo especial. Esto genera anticipación y confianza.',
      },
    ],
