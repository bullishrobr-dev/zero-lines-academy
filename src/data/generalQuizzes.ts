...
const syringePricingQuiz: GeneralQuiz = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        '{currency}300 with a second syringe free, which is Offer Option 2, not Option 1',
        '{currency}175 with the gift removed, which is the adaptive step further down the ladder',
        '{currency}140 with the 20% voucher, which you only use at the very end',
        '{currency}210 (30% off) + free gift (cream/cleanser/peeling choice)',
      ],
      optionsEs: [
        '{currency}300 con una segunda jeringuilla gratis, que es la Opción 2, no la Opción 1',
        '{currency}175 sin el regalo, que es el paso adaptativo más abajo en la escalera',
        '{currency}140 con el cupón del 20%, que solo usas al final del todo',
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        '"You do not need his permission — it is your face and your money, and I am sure he does not ask you before he buys things for himself"',
      ...
      optionsEs: [
        ...
        '"No necesitas su permiso — es tu cara y tu dinero, y seguro que él no te pregunta antes de comprarse sus cosas"',
    ...
    },
    {
      ...
      options: [
        ...
        '"Do not think, just buy it! Thinking is what kills these decisions — everyone who walks out to think about it ends up regretting it later"',
      ...
      optionsEs: [
        ...
        '"¡No lo pienses, cómpralo! Pensarlo es lo que mata estas decisiones — todo el mundo que sale a pensárselo acaba arrepintiéndose"',
